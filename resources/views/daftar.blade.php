                                    ...
                                    <form method="POST" action="{{Route('userCreate')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix">
                                                ...
                                                <input required type="text" name="name" class="form-control" id="name" placeholder="Nama Lengkap">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix">
                                                <i class="prefix-icon anticon anticon-user"></i>
                                                <input required type="email" name="email" class="form-control" id="userName" placeholder="Username">
                                            </div>
                                        </div>
                                        <div class="form-group">
